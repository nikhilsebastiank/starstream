...
#' @return Histograms with Indicative Revenue on the Horizontal Axis
#' @export

plotHistograms = function(workingdir = "~/Dropbox/Projects/MasterThesis", results = paste(workingdir, "/results/graphs", sep = "")){
  ...
  cowplot::save_plot(plot = fullhist, path = results, ncol = 3, nrow = 4, filename = "evolutionHistograms.png")
}
